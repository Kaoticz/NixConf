...
# Synced to commit: https://github.com/arkenfox/user.js/commit/4d78abf2bfafbbcb03f8f6d6aaaf7e69b7cfee4e
{
  ...
  "browser.safebrowsing.downloads.remote.url" = ""; # Comment this if the above is set to "true".
  ...
  "network.trr.mode" = 3;
  "network.trr.uri" = "https://open.dns0.eu/"; # Required if network.trr.mode is 2 or 3
  "network.trr.custom_uri" = "https://open.dns0.eu/"; # Required if network.trr.mode is 2 or 3
